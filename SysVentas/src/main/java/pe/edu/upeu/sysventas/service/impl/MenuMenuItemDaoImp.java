...
public class MenuMenuItemDaoImp implements IMenuMenuItemDao {
    ...
    public List<MenuMenuItenTO> listaAccesos(String perfil, Properties idioma) {
        ...
        lista.add(new MenuMenuItenTO("miusuario", "/view/main_usuario.fxml", idioma.getProperty("menu.nombre.usuario", "Usuarios"), idioma.getProperty("menuitem.nombre.usuario", "Gestión Usuario"), "Gestión de Usuarios", "T"));
